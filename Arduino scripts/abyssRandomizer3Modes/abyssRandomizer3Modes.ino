...
void loop() {
  ...
  if (mode == 3) {
    int numOfCharMode3 = 30;
    String characterMode3[numOfCharMode3] = {"heizou", "yun jin", "gorou", "thoma", "kujou sara", "aloy", "sayu", "kazuha",
     "yanfei", "rosaria", "hutao", "xiao", "zhongli", "xinyan", "childe", "diona", "keqing", "chongyun", "noelle", "bennett", "fischl"
     "ningguang", "xingqiu", "beidou", "xiangling", "razor", "barbara", "lisa", "kaeya", "amber"};
    Serial.print("TEAM 1: ");
    for (int i = 0; i < 4; i++) {
      pickChar=random(0,numOfCharMode3);
      assignedChar = characterMode3[pickChar];
      while (assignedChar == "null") {
        pickChar = random(0, numOfCharMode3);
        assignedChar = characterMode3[pickChar];
      }
