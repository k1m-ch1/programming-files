(function(g){var window=this;'use strict';var idb=function(a){g.W.call(this,{F:"div",K:"ytp-miniplayer-ui"});this.Mf=!1;this.player=a;this.S(a,"minimized",this.Hh);this.S(a,"onStateChange",this.FN)},jdb=function(a){g.LQ.call(this,a);
this.u=new g.vF(this);this.j=new idb(this.player);this.j.hide();g.cQ(this.player,this.j.element,4);a.cg()&&(this.load(),g.lo(a.getRootNode(),"ytp-player-minimized",!0));this.player.N("web_rounded_containers")&&g.lo(a.getRootNode(),"ytp-rounded-miniplayer",!0)};
g.v(idb,g.W);g.k=idb.prototype;
g.k.PK=function(){this.tooltip=new g.RU(this.player,this);g.H(this,this.tooltip);g.cQ(this.player,this.tooltip.element,4);this.tooltip.scale=.6;this.Nc=new g.ER(this.player);g.H(this,this.Nc);this.Wi=new g.W({F:"div",K:"ytp-miniplayer-scrim"});g.H(this,this.Wi);this.Wi.Ca(this.element);this.S(this.Wi.element,"click",this.OF);var a=new g.W({F:"button",Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.ZM()]});g.H(this,a);a.Ca(this.Wi.element);this.S(a.element,"click",this.Bo);
a=new g.w2(this.player,this);g.H(this,a);a.Ca(this.Wi.element);this.Tt=new g.W({F:"div",K:"ytp-miniplayer-controls"});g.H(this,this.Tt);this.Tt.Ca(this.Wi.element);this.S(this.Tt.element,"click",this.OF);var b=new g.W({F:"div",K:"ytp-miniplayer-button-container"});g.H(this,b);b.Ca(this.Tt.element);a=new g.W({F:"div",K:"ytp-miniplayer-play-button-container"});g.H(this,a);a.Ca(this.Tt.element);var c=new g.W({F:"div",K:"ytp-miniplayer-button-container"});g.H(this,c);c.Ca(this.Tt.element);this.NU=new g.kT(this.player,
this,!1);g.H(this,this.NU);this.NU.Ca(b.element);b=new g.iT(this.player,this);g.H(this,b);b.Ca(a.element);this.nextButton=new g.kT(this.player,this,!0);g.H(this,this.nextButton);this.nextButton.Ca(c.element);this.Zi=new g.EU(this.player,this);g.H(this,this.Zi);this.Zi.Ca(this.Wi.element);this.Hc=new g.vT(this.player,this);g.H(this,this.Hc);g.cQ(this.player,this.Hc.element,4);this.EF=new g.W({F:"div",K:"ytp-miniplayer-buttons"});g.H(this,this.EF);g.cQ(this.player,this.EF.element,4);a=new g.W({F:"button",
Ga:["ytp-miniplayer-close-button","ytp-button"],X:{"aria-label":"Close"},W:[g.ZM()]});g.H(this,a);a.Ca(this.EF.element);this.S(a.element,"click",this.Bo);a=new g.W({F:"button",Ga:["ytp-miniplayer-replay-button","ytp-button"],X:{"aria-label":"Close"},W:[g.fN()]});g.H(this,a);a.Ca(this.EF.element);this.S(a.element,"click",this.y4);this.S(this.player,"presentingplayerstatechange",this.qd);this.S(this.player,"appresize",this.Bb);this.S(this.player,"fullscreentoggled",this.Bb);this.Bb()};
...
g.k.y4=function(){this.player.playVideo()};
...
g.k.tq=function(){};
g.k.DD=function(){};
g.k.jr=function(){};g.v(jdb,g.LQ);g.k=jdb.prototype;g.k.onVideoDataChange=function(){if(this.player.N("web_rounded_containers")&&this.player.getVideoData()){var a=16/9;a=this.player.getVideoAspectRatio()>a+.1;g.lo(this.player.getRootNode(),"ytp-rounded-miniplayer-extra-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.KQ("miniplayer",jdb);})(_yt_player);
